module mycpu_top(
    ...
    wire [3:0]  cache_data_wstrb;
    wire [7:0]  cache_data_len  ;
    ...
    wire [3:0]  wrap_data_wstrb;
    wire [7:0]  wrap_data_len  ;
    ...
    .ram_data_wstrb   (cache_data_wstrb),
    .ram_data_len     (cache_data_len  ),
    ...
    .wrap_data_wstrb   (wrap_data_wstrb),
    .wrap_data_len     (wrap_data_len  ),
    ...
    .data_wstrb     (wrap_data_wstrb),
    .data_len       (wrap_data_len  ),
